    ...
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white p-3 sm:p-6">
        ...
        <AnimatePresence>
          {showAddForm && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="mb-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-lg"
            >
              <div className="flex items-center justify-between mb-4">
      ...
      {/* Departments List */}
        {departments.length === 0 ? (
          ...
          <div className="grid gap-4 sm:gap-6">
              ...
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 sm:p-6 hover:border-blue-500 transition-colors shadow-sm dark:shadow-none"
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="px-2 py-1 rounded-full text-xs font-medium bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                        {department.code}
                      </span>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center shadow-sm">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center shadow-sm">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">Inactive Departments</div>
          </div>
        </div>
      </div>
    </div>
