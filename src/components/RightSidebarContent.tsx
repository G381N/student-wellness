...
import { FiUser, FiSettings, FiLogOut, FiEdit, FiTrash2, FiPlus } from 'react-icons/fi';
...
export default function RightSidebarContent({ onCreatePost }: RightSidebarContentProps) {
